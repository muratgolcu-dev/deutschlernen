...
const translations = {
  ...
  'grammar.whyWrong': { tr: 'Neden?', en: 'Why?' },
  'grammar.rule': { tr: 'Kural', en: 'Rule' },
  'grammar.example': { tr: 'Örnek', en: 'Example' },
  'grammar.mistakeReview': { tr: 'Hata Tekrarı', en: 'Mistake Review' },
  'grammar.mistakeCount': { tr: 'Önceki hatalardan tekrar soruları', en: 'Review questions from previous mistakes' },
  'grammar.noMistakes': { tr: 'Tekrar edilecek hata yok!', en: 'No mistakes to review!' },
  'grammar.mistakesRemaining': { tr: 'tekrar edilecek hata', en: 'mistakes to review' },
  'grammar.reviewMistakes': { tr: 'Hataları Tekrarla', en: 'Review Mistakes' },
  'grammar.correctAnswer': { tr: 'Doğru cevap', en: 'Correct answer' },
  'grammar.yourAnswer': { tr: 'Senin cevabın', en: 'Your answer' },
