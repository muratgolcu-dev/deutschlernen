...
const translations = {
  ...
  'vocab.importPdf': { tr: 'PDF İçe Aktar', en: 'Import PDF' },
  'vocab.importPdfDesc': { tr: 'PDF dosyasından kelime çıkar', en: 'Extract words from PDF file' },
  'vocab.importing': { tr: 'Analiz ediliyor...', en: 'Analyzing...' },
  'vocab.extractingText': { tr: 'Metin çıkarılıyor...', en: 'Extracting text...' },
  'vocab.analyzingWords': { tr: 'Kelimeler analiz ediliyor...', en: 'Analyzing words...' },
  'vocab.importSuccess': { tr: 'kelime başarıyla içe aktarıldı!', en: 'words imported successfully!' },
  ...
  'vocab.selectPdf': { tr: 'PDF dosyası seçin', en: 'Select a PDF file' },
  'vocab.wordsFound': { tr: 'kelime bulundu', en: 'words found' },
  'vocab.addToVocabulary': { tr: 'Kelime Havuzuna Ekle', en: 'Add to Vocabulary' },
  'vocab.cancel': { tr: 'İptal', en: 'Cancel' },
  'vocab.customCategories': { tr: 'İçe Aktarılan Kategoriler', en: 'Imported Categories' },
